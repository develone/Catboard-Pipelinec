...
def jpeg(clk_fast, left_s, right_s, sam_s, res_s, lo_hi_s , fwd_inv_s  ):
	...
	return hdl
def testbench():
	i_inst = jpeg( clk_fast, left_s, right_s, sam_s, res_s, lo_hi_s , fwd_inv_s)
...
def convert():			
	toVerilog(jpeg, clk_fast, left_s, right_s, sam_s, res_s, lo_hi_s , fwd_inv_s)
	toVHDL(jpeg, clk_fast, left_s, right_s, sam_s, res_s, lo_hi_s , fwd_inv_s)
convert()
